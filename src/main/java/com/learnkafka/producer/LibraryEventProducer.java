...
public class LibraryEventProducer {
    ...
    public void sendLibraryEvents(LibraryEvent libraryEvent) throws JsonProcessingException {
        ...
        ListenableFuture<SendResult<Integer, String>> listenableFuture = (ListenableFuture<SendResult<Integer, String>>) kafkaTemplate.sendDefault(key, value);
    ...
    public ListenableFuture<SendResult<Integer, String>> sendLibraryEvent_Approach2(LibraryEvent libraryEvent) throws JsonProcessingException {
        ...
        ListenableFuture<SendResult<Integer, String>> listenableFuture = (ListenableFuture<SendResult<Integer, String>>) kafkaTemplate.send(producerRecord);
